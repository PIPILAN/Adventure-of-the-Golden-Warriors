...
//打印机修改
recipes.remove(<cfm:printer:0>);
recipes.addShaped(<cfm:printer:0>,[
                    [<ore:stone>,<inventorypets:illuminati_pet>,<ore:stone>],
                    [<minecraft:iron_block:0>,<ore:paper>,<minecraft:iron_block:0>],
                    [<ore:stone>,<inventorypets:enchanting_table_pet>,<ore:stone>]]);